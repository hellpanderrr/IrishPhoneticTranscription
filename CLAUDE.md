...
## Benchmark Target
- Current: ~64.61% exact match (4263/6598) Connacht
- Norm Lev: 91.51, Norm Dolgo: 93.47
- Lev-1 single-substitution error buckets in `_base.tsv`
- Previous: ~44.17% (2912/6593), theory-grounding → ~60.52% (3993/6598), retracted/dental → ~64.25% (4239/6598), ngh+mh/bh → ~64.26% (4240/6598), velar assimilation → ~64.61% (4263/6598)
