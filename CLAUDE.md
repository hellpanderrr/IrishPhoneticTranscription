...
## Benchmark Target
- Current: ~66.69% exact match (4400/6598) Connacht
- Norm Lev: 92.45, Norm Dolgo: 94.52
- Lev-1 single-substitution error buckets in `_base.tsv`
- Previous: ~44.17% (2912/6593), theory-grounding → ~60.52% (3993/6598), retracted/dental → ~64.25% (4239/6598), ngh+mh/bh → ~64.26% (4240/6598), velar assimilation → ~64.61% (4263/6598), s broad before labials → ~64.84% (4278/6598), amh/uː vocalization + niamh/riamh → ~65.16% (4299/6598), function words + future-f + epenthesis → ~66.60% (4394/6598), oí→iː vowel digraph → ~66.69% (4400/6598)
