...
rules.rules_stage1_5_ortho_cluster_simplification = {
...
rules.rules_stage2_mark_digraphs_and_vocalisation_triggers = {
    {
...
for _, fric in ipairs(preceding_fricatives) do
    for _, sonorant in ipairs(palatal_sonorants) do
        ...
        table.insert(rules.rules_stage2_mark_digraphs_and_vocalisation_triggers, rule)
    end
end
...
rules.rules_stage2_5_mark_suffixes = {
...
{ p = N("(fad)(#?)$"),   r = function(fm, sfx, b) return N("MKR_SUFFIX_FAD") .. (b or "") end,   ortho_len_func = function(fm, sfx, b) return ulen(sfx) end },
    ...
    p = N("(aire)(#?)$"),
    r = function(fm, sfx, b) return N("MKR_SUFFIX_AIRE") .. (b or "") end,
    ortho_len_func = function(fm, sfx, b) return ulen(sfx) end
}, {
    p = N("(aim)(#?)$"),
    r = function(fm, sfx, b) return N("MKR_SUFFIX_AIM") .. (b or "") end,
    ortho_len_func = function(fm, sfx, b) return ulen(sfx) end
}, {
    p = N("(im)(#?)$"),
    r = function(fm, sfx, b) return N("MKR_SUFFIX_IM") .. (b or "") end,
    ortho_len_func = function(fm, sfx, b) return ulen(sfx) end
}, {
    p = N("(aint)(ing)(t?)$"),
    r = function(fm, a, s, t) return a .. N("MKR_SUFFIX_ING") .. (t or "") end,
    ortho_len_func = function(fm, a, s, t) return ulen(s .. (t or "")) end
}, {
    p = N("(each)(#?)$"),
    r = function(fm, sfx, b) return N("MKR_SUFFIX_ƏX") .. (b or "") end,
    ortho_len_func = function(fm, sfx, b) return ulen(sfx) end
...
rules.rules_stage3_1_marker_resolution = {}
do
    local rules = {
...
{ p = N("MKR_BH_INTERVOCALIC"), r = N("w") }, -- Realizes as the consonant [w]
    ...
    rules.rules_stage3_1_marker_resolution = rules
end

rules.rules_stage3_5_consonant_assimilation = {
    { p = N("(d')(f')"), r = N("t'%2") }
}
rules.rules_stage4_0_specific_ortho_to_temp_marker = {
    {
...
rules.rules_stage4_0_1_resolve_ch_marker = {
    {
        p = N("MKR_CH"),
...
rules.rules_stage4_1_vocmark_to_temp_marker = {}
rules.rules_stage4_2_long_vowels_ortho_to_temp_marker = {
...
rules.rules_stage4_3_diphthongs_ortho_to_temp_marker = {
...
rules.rules_stage4_4_resolve_temp_vowel_markers = {
    ...
    { p = N("MKR_SUFFIX_AIRE"), r = N("əɾʲə") },
    { p = N("MKR_SUFFIX_AIM"), r = N("iːmʲ") },
    { p = N("MKR_SUFFIX_IM"), r = N("əmʲ") },
    { p = N("MKR_SUFFIX_ING"), r = N("ən̠ʲ") },
...
rules.rules_stage4_5_2_connacht_specific_vowel_shifts = {
    { p = N("(oː)(nʲ)"), r = N("uː%2") },
    { p = N("(oː)(" .. ZZZ_N_STR_PAL_PHON .. ")"), r = N("uː%2") }
}

rules.rules_stage4_5_contextual_allophony_on_phonetic = {
...
rules.rules_stage4_6_unstressed_vowel_reduction_specific_finals = {
    { p = N("aí$"), r = N("iː") }, { p = N("eiə$"), r = N("iː") },
    { p = N("iːə$"), r = N("iː") }
}
rules.EPENTHESIS_TARGET_CLUSTERS_BROAD = {
...
rules.EPENTHESIS_TARGET_CLUSTERS_SLENDER = {
    -- Sonorant + Voiced Stop (Heterorganic)
    [N("rg")] = true,
    [N("rb")] = true,
    -- Sonorant + Voiced Fricative
...
rules.rules_stage5_strong_sonorants_only = {}
do
...
rules.rules_stage7_final_cleanup = {
...
function rules.process_sandhi(words_data)
...
function rules.transcribe_single_word(orthographic_word_input)
    ...
    local stages = {
        ...
        { name = "Stage4_1_VocmarkToTempMarker",         rules = rules.rules_stage4_1_vocmarkToTempMarker,              mode = "single_pass_priority_match" },
...
function rules.transcribe(orthographic_phrase)
    ...
    for i, component in ipairs(components) do
        if component.type == "word" then
            component.phon = rules.transcribe_single_word(component.ortho)
        else
    ...
    components = rules.process_sandhi(components)
...
if input then
    ...
    original_print_func(rules.transcribe(N(input)))
else
    ...
    if RUN_DEFAULT_TESTS_IF_NO_INPUT then
        ...
        for _, word_or_phrase in ipairs(words_to_test_focused_from_errors) do
            ...
            local transcribed = rules.transcribe(original)
...
-- Export global rules for hybrid module loading
rules.placeholder_creation_rules_stage4_5 = placeholder_creation_rules_stage4_5
rules.placeholder_restoration_rules_stage4_5 = placeholder_restoration_rules_stage4_5
rules.core_allophony_rules_for_stage4_5 = core_allophony_rules_for_stage4_5
rules.connacht_au_to_schwa_u_shift_rule_stage4_5 = connacht_au_to_schwa_u_shift_rule_stage4_5
rules.temp_conn_au_to_final_au_rule_stage4_5 = temp_conn_au_to_final_au_rule_stage4_5
